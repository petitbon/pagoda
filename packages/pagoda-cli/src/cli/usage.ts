export const usage = `Usage:
  ...
  pagoda scenario create --id <id> [--root <path>] [--title <title>] [--channel <channel>] [--outcome <outcome>] [--domain <domain>] [--risk <risk>]
  pagoda codex install [--root <path>] [--force]
  pagoda run [--root <path>] [--adapter <id>] [--channel <channel>] [--seed <seed>] [--reporter default|json]
  pagoda run [--root <path>] [--adapter <id>] --scenario <id> [--channel <channel>] [--seed <seed>] [--artifact-directory <path>] [--reporter default|json]
