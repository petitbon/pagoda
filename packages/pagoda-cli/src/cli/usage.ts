export const usage = `Usage:
  ...
  pagoda run [--root <path>] [--target <id>] [--adapter <id>] [--channel <channel>] [--seed <seed>] [--interaction-cases all] [--concurrency <n>] [--sequential <n>] [--reporter default|json]
  pagoda run [--root <path>] [--target <id>] [--adapter <id>] --scenario <id> [--channel <channel>] [--seed <seed>] [--interaction-case <case-id|index>] [--interaction-cases all] [--artifact-directory <path>] [--concurrency <n>] [--sequential <n>] [--reporter default|json]
